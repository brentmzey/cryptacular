...
public abstract class AbstractPrivateKeyDecoder<T> implements ASN1Decoder<T> {
    ...
    /**
     * Tests the given encoded input and converts it to PEM if it is detected, stripping out any
     * header/footer data in the process.
     *
    ...
    /**
     * Decrypts an encrypted key in either PKCS#8 or OpenSSL "traditional" format. Both PEM and DER
    ...
    /**
     * Decodes the given raw ASN.1 encoded data into a private key of the type supported by this
     * class.
     *
