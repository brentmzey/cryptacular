...
/**
 * Reads X.509 subject and issuer DNs as a raw sequence of attributes to facilitate precise handling
 * of name parsing.
 *
...
public class NameReader {
    ...
    /**
     * Creates a new instance to support reading subject and issuer information on the given
     * certificate.
     *
    ...
    /**
     * Converts the given X.500 principal to a list of relative distinguished names that contains
     * the attributes comprising the DN.
     *
    ...
    /**
     * Converts the given X.500 name to a list of relative distinguished names that contains the
