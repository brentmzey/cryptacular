...
public class RDNSequence implements Iterable<RDN> {
    ...
    /**
     * Gets an immutable list of all attributes of the given type. The order of the returned list
     * reflects the ordering of the RDNs and their attributes.
     *
     * @param type Attribute type.
     * @return Non-null list of attributes of given type. An empty list is returned if there are no
    ...
    /**
     * Gets the first value of the given type that appears in the attribute list of any RDN in the
     * sequence.
     *
     * @param type Attribute type.
     ...
     *
     * @return String representation that resembles an X.509 distinguished name, e.g. <code>
     *     CN=foo, OU=Bar, dc=example,
     *          dc=com</code>.
     */
    @Override
