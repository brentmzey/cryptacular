...
/**
 * Representation of the options in the CHOICE element describing various categories of the <code>
 * GeneralName</code> type defined in section 4.2.1.7 of RFC 2459.
 *
...
public enum GeneralNameType {
     ...
     * @throws IllegalArgumentException If there is not a general name type corresponding to the
     *     given tag number.
     */
