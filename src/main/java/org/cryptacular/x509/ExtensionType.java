...
public enum ExtensionType {
     ...
     * @param criticality True if extension MUST or SHOULD be marked critical under general
     ...
     *
     * @param name Case-sensitive X.509v3 extension name. The acceptable case of extension names is
     *     governed by conventions in RFC 2459.
    ...
    /**
     * @return True if extension MUST or SHOULD be marked critical under general circumstances
     *     according to RFC 2459, false otherwise.
     */
