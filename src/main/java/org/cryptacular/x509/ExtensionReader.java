...
/**
 * Reads X.509v3 extended properties from an {@link java.security.cert.X509Certificate} object. The
...
public final class ExtensionReader {
     ...
     *
     * @param extensionOidOrName OID or extension name, e.g. 2.5.29.14 orSubjectK eyIdentifier. In
     *     the case of extension name, the name is case-sensitive and follows the conventions in RFC
     *     2459.
     ...
     *
     * @return Collection of subject alternative names or null if the certificate does not define
     *     this extension field. Note that an empty collection of names is different from a null
     *     return value; in the former case the field is defined but empty, whereas in the latter
     ...
     *
     * @return Collection of issuer alternative names or null if the certificate does not define
     *     this extension field. Note that an empty collection of names is different from a null
     *     return value; in the former case the field is defined but empty, whereas in the latter
     *     the field is not defined on the certificate.
     * @throws EncodingException On certificate field parse errors.
     ...
     *
     * @return Basic constraints defined on certificate or null if the certificate does not define
     *     the field.
     * @throws EncodingException On certificate field parse errors.
     */
     ...
     *
     * @return List of certificate policies defined on certificate or null if the certificate does
    ...
    /**
     * Reads the value of the <code>AuthorityKeyIdentifier</code> extension field of the
     * certificate.
     *
