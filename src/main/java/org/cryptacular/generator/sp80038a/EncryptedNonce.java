 ...
 * href="http://goo.gl/S9z8qF">SP-800-38a</a>, appendix C, method 1 (encrypted nonce), suitable for
 * use with any block cipher mode described in that standard except OFB.
 *
