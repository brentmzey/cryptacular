...
/**
 * Generates PKCS12 containers using DES3+SHA1 for private keys and 40-bit RC2+SHA1 for encrypted
 * data. These algorithms are considered unsecure by today's standards (2024), but are needed for
 * interoperability in some cases. Importing a keypair into the Mac keychain is a notable use case.
 *
