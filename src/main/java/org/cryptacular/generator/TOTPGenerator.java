...
public class TOTPGenerator extends AbstractOTPGenerator {
    ...
    /**
     * Current system time in seconds since the start of the epoch, 1970-01-01T00:00:00. This value
     * is used if and only if it is a non-negative value; otherwise the current system time is used.
     */
     ...
     *
     * @param seconds Time step in seconds. Default is 30. This value determines the validity window
     *     of generated OTP values.
     */
    ...
    /**
     * Sets the current time (supports testing). This value is used if and only if it is a
     * non-negative value; otherwise the current system time is used.
     *
