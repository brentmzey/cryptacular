...
public final class CodecUtil {
    ...
    /**
     * Encodes raw bytes to the equivalent hexadecimal encoded string with optional delimiting of
     * output.
     *
     * @param raw Raw bytes to encode.
     * @param delimit True to delimit every two characters (i.e. every byte) of output with ':'
