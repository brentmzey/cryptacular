...
public final class NonceUtil {
     ...
     * {@link System#nanoTime()}) up to the required size.
     *
     ...
     * href="http://csrc.nist.gov/publications/nistpubs/800-38D/SP-800-38D.pdf">SP-800-38d</a>,
     * section 8.2.2, "RBG-based Construction". The implementation uses a hash-based DRBG based on a
     * SHA-256 digest, and uses random data for all bits of the nonce; that is, the fixed field is
     * null.
     *
     * <p>This nonce generation strategy is suitable for GCM ciphers.
     *
    ...
    /**
     * Generates a random IV according to NIST <a href="http://goo.gl/S9z8qF">SP-800-63a</a>,
     * appendix C, method 1 (encrypted nonce), suitable for use with any block cipher mode described
     * in that standard. This method uses an instance of {@link EncryptedNonce} for the
     * implementation.
     *
    ...
    /**
     * Generates a random IV according to NIST <a href="http://goo.gl/S9z8qF">SP-800-63a</a>,
     * appendix C, method 2 (pseudorandom), suitable for use with any block cipher mode described in
     * that standard.
     *
     ...
     * Generates a random IV according to NIST <a href="http://goo.gl/S9z8qF">SP-800-63a</a>,
     * appendix C, method 2 (pseudorandom), suitable for use with any block cipher mode described in
     * that standard. Uses an instance of {@link RBGNonce} internally with length equal to block
     * size of given cipher.
     *
     * @param cipher Block cipher.
     * @return Cipher block size number of random bytes.
     * @see RBGNonce
     ...
     * @return New DRGB instance.
     */
    public static SP80090DRBG newRBG(
            final Digest digest, final int length, final EntropySource es) {
