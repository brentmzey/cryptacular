...
public final class ReflectUtil {
    ...
    /**
     * Gets the method defined on the target class. The method is cached to speed up subsequent
     * lookups.
     *
    ...
    public static Method getMethod(
            final Class<?> target, final String name, final Class<?>... parameters) {
    ...
    public static Object invoke(
            final Object target, final Method method, final Object... parameters) {
        try {
