...
public final class PemUtil {
     ...
     * The determination is made using as little data from the given array as necessary to make a
     * reasonable determination about encoding.
     *
    ...
    /**
     * Determines whether the given byte represents an ASCII character in the character set for
     * base64 encoding.
     *
     * @param b Byte to test.
     * @return True if the byte represents an ASCII character in the set of valid characters for
     *     base64 encoding, false otherwise. The padding character '=' is not considered valid since
     *     it may only appear at the end of a base64 encoded value.
     */
     ...
     * Header/footer data and metadata info, e.g. Proc-Type, are ignored.
     *
    ...
    /**
     * Decodes one or more PEM-encoded cryptographic objects into the raw bytes of their ASN.1
     * encoding. All header and metadata, e.g. Proc-Type, are ignored. If multiple cryptographic
     * objects are represented, the decoded bytes of each object are concatenated together and
     * returned.
     *
