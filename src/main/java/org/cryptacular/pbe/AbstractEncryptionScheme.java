...
/**
 * Abstract base class for password-based encryption schemes based on salt data and iterated hashing
 * as the basis of the key derivation function.
 *
 * <p>NOTE: Classes derived from this class are not thread safe. In particular, care should be take
 * to prevent multiple threads from performing encryption and/or decryption concurrently.
 *
