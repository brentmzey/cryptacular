...
/**
 * Describes an AEAD block cipher in terms of a (algorithm, mode) tuple and provides a facility to
 * create a new instance of the cipher via the {@link #newInstance()} method.
 *
...
public class AEADBlockCipherSpec implements Spec<AEADBlockCipher> {
    ...
    public AEADBlockCipher newInstance() {
        ...
        switch (mode) {
            ...
            case "OCB":
                aeadBlockCipher =
                        new OCBBlockCipher(
                                blockCipher, new BlockCipherSpec(algorithm).newInstance());
                break;
    ...
    /**
     * Parses a string representation of a AEAD block cipher specification into an instance of this
     * class.
     *
