...
/**
 * Cipher bean that performs symmetric encryption/decryption using a standard block cipher in a
 * standard mode (e.g. CBC, OFB) with padding to support processing inputs of arbitrary length.
 *
