 ...
 * {@link KeyPairUtil#decodePrivateKey(byte[])}. Note that this component does not support encrypted
 * private keys; see {@link ResourceBasedPrivateKeyFactoryBean} for encryption support.
 *
