...
public abstract class AbstractHashBean {
    ...
    /**
     * @return Digest specification that determines the instance of {@link Digest} used to compute
     *     the hash.
     */
    ...
    /**
     * Sets the digest specification that determines the instance of {@link Digest} used to compute
     * the hash.
     *
