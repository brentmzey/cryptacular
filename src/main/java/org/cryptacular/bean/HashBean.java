...
/**
 * Strategy interface to support beans that produce hash outputs in various formats, e.g. raw bytes,
 * hex output, etc.
 *
...
public interface HashBean<T> {
     ...
     *     <code>byte[]</code>, {@link CharSequence}, {@link java.io.InputStream}, and {@link
     *     org.cryptacular.io.Resource}. Unless otherwise noted, character data is processed in the
     *     <code>UTF-8</code> character set; if another character set is desired, the caller should
