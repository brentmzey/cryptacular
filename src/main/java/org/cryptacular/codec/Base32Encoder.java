...
public class Base32Encoder extends AbstractBaseNEncoder {
    ...
    /**
     * Creates a new instance that produces base 32-encoded output in the RFC 4648 alphabet, <code>
     * ABCDEFGHIJKLMNOPQRSTUVWXYZ234567</code>, with no line breaks in the output.
     */
    ...
    /**
     * Creates a new instance that produces base 32-encoded output in the RFC 4648 alphabet, <code>
     * ABCDEFGHIJKLMNOPQRSTUVWXYZ234567</code>, with the given number of characters per line in the
     * output.
     *
    ...
    /**
     * Creates a new instance that produces base 32-encoded output in the given 32-character
     * alphabet with no line breaks in the output.
     *
    ...
    /**
     * Creates a new instance that produces base 32-encoded output in the given 32-character
     * alphabet with the given number of characters per line in the output.
     *
     * @param alphabet 32-character alphabet to use.
     * @param charactersPerLine Number of characters per line. A zero or negative value disables
     *     line breaks.
