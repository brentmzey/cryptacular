...
public class Base64Encoder extends AbstractBaseNEncoder {
    ...
    /**
     * Creates a new instance that produces base 64-encoded output with no line breaks in the
    ...
    /**
     * Creates a new instance that produces base 64-encoded output with no line breaks and optional
    ...
    /**
     * Creates a new instance that produces base 64-encoded output with the given number of
     * characters per line in the default character set.
     *
     * @param charactersPerLine Number of characters per line. A zero or negative value disables
     *     line breaks.
     */
    ...
    /**
     * Creates a new instance that produces base 64-encoded output with the given number of
     * characters per line with the option of URL-safe character set.
     *
     * @param urlSafe True to use URL and filesystem-safe character set, false otherwise.
     * @param charactersPerLine Number of characters per line. A zero or negative value disables
     *     line breaks.
    ...
    /**
     * Creates a new instance that produces base 64-encoded output with the given 64-character
     * alphabet.
     *
    ...
    /**
     * Creates a new instance that produces base 64-encoded output with the given 64-character
     * alphabet with line wrapping at the specified line length;
     *
     * @param alphabet 64-character alphabet to use.
     * @param charactersPerLine Number of characters per line. A zero or negative value disables
     *     line breaks.
    ...
    public static class Builder {
         ...
         *
         * @param lineLength Number of characters per line. Set to <code>-1</code> to suppress line
         *     breaks.
         * @return This instance.
         */
