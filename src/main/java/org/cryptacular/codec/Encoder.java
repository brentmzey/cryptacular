...
public interface Encoder {
    ...
    /**
     * Encodes bytes in input buffer into characters placed in the output buffer. This method may be
     * called multiple times, followed by {@link #finalize(java.nio.CharBuffer)} after all input
