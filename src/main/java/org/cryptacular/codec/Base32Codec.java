...
public class Base32Codec implements Codec {
    ...
    /**
     * Creates a new instance using the RFC 4328 alphabet, <code>ABCDEFGHIJKLMNOPQRSTUVWXYZ234567
     * </code>.
     */
    public Base32Codec() {
    ...
    /**
     * Creates a new instance using the given 32-character alphabet with option to enable/disable
     * padding.
     *
     * @param alphabet 32-character alphabet to use.
