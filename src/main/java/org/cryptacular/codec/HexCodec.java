...
public class HexCodec implements Codec {
    ...
    /**
     * Creates a new instance that outputs lowercase hex characters and supports decoding in either
     * case.
     */
    public HexCodec() {
        this(false);
    ...
    /**
     * Creates a new instance that optionally outputs uppercase hex characters and supports decoding
     * in either case.
     *
