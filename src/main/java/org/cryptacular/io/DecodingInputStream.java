...
/**
 * Filters read bytes through a {@link Decoder} such that consumers obtain raw (decoded) bytes from
 * read operations.
 *
...
public class DecodingInputStream extends FilterInputStream {
    ...
    /**
     * Creates a new instance that wraps the given stream and performs decoding using the given
     * encoder component.
     *
