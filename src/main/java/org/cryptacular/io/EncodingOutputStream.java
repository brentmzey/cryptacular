...
/**
 * Filters written bytes through an {@link Encoder} such that encoded data is written to the
...
public class EncodingOutputStream extends FilterOutputStream {
    ...
    /**
     * Creates a new instance that wraps the given stream and performs encoding using the given
     * encoder component.
     *
     ...
     *
     * <p><strong>NOTE:</strong> there are no line breaks in the output with this version.
     *
     ...
     * Creates a new instance that produces base64 output in the given stream.
     *
     * <p><strong>NOTE:</strong> this version supports output with configurable line breaks.
     *
     * @param out Wrapped output stream.
     * @param lineLength Length of each base64-encoded line in output. A zero or negative value
     ...
     *
     * <p><strong>NOTE:</strong> there are no line breaks in the output.
     *
     * @param out Wrapped output stream.
