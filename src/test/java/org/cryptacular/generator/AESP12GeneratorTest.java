...
public class AESP12GeneratorTest {
    ...
    public Object[][] getP12Params() {
        return new Object[][] {
            new Object[] {
                "aes256-sha256-2048", "/keystores/alpha.p12", NISTObjectIdentifiers.id_sha256, 2048
            },
            new Object[] {
                "aes256-sha512-4196", "/keystores/alpha.p12", NISTObjectIdentifiers.id_sha512, 4196
            },
        };
    }
    ...
    public void testGenerate(
        ...
        Assert.assertEquals(
                p12.getContentInfos()[0].getContentType().toString(), "1.2.840.113549.1.7.6");
        // Shrouded bag (key)
        Assert.assertEquals(
                p12.getContentInfos()[1].getContentType().toString(), "1.2.840.113549.1.7.1");
        ...
        final RSAPrivateKey genKey =
                (RSAPrivateKey) generated.getKey("end-entity-cert", passwordChars);
        Assert.assertEquals(genKey.getPrivateExponent(), privateKey.getPrivateExponent());
        final X509Certificate genCert =
                (X509Certificate) generated.getCertificate("end-entity-cert");
