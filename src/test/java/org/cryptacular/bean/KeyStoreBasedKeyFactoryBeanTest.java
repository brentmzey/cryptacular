...
public class KeyStoreBasedKeyFactoryBeanTest {
    ...
    public Object[][] getKeys() {
        return new Object[][] {
            {
                KS_PATH + "factory-bean.jceks", "JCEKS", "aes256", "AES", 32,
            },
            {
                KS_PATH + "factory-bean.jceks", "JCEKS", "rsa2048", "RSA", 2048,
            },
        };
    }
    ...
    public void testNewInstance(
        ...
        final KeyStoreBasedKeyFactoryBean<? extends Key> secretKeyFactory =
