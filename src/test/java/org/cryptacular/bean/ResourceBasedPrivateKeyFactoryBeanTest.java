...
public class ResourceBasedPrivateKeyFactoryBeanTest {
    ...
    public Object[][] getKeys() {
        return new Object[][] {
            ...
            new Object[] {
                KEY_PATH + "ec-openssl-sect571r1-explicit-nopass.pem", null,
            },
            new Object[] {KEY_PATH + "dsa-openssl-des3.pem", "vtcrypt"},
            new Object[] {KEY_PATH + "dsa-pkcs8-v2-des3.der", "vtcrypt"},
            new Object[] {
                KEY_PATH + "ec-pkcs8-sect571r1-explicit-v2-aes128.pem", "vtcrypt",
            },
            new Object[] {
                KEY_PATH + "ec-pkcs8-sect571r1-named-v1-sha1-rc2-64.der", "vtcrypt",
            },
    ...
    public void testNewInstance(final String path, final String password) throws Exception {
