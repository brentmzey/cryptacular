...
public class AEADBlockCipherBeanTest {
    ...
    public Object[][] getTestArrays() {
        return new Object[][] {
            new Object[] {
                ...
                "Able was I ere I saw elba.", "AES/GCM",
            },
            // Plaintext is multiple of block size
            new Object[] {
                "Four score and seven years ago, our forefathers ", "Twofish/CCM",
            },
            // OCB
            new Object[] {
                "Have you passed through this night?", "Twofish/OCB",
            },
            // EAX
            new Object[] {
    ...
    public Object[][] getTestStreams() {
        return new Object[][] {
            new Object[] {
                "src/test/resources/plaintexts/lorem-5000.txt", "Twofish/GCM",
            },
            new Object[] {
                "src/test/resources/plaintexts/lorem-1200.txt", "AES/OCB",
            },
            new Object[] {
                "src/test/resources/plaintexts/lorem-1200.txt", "AES/EAX",
            },
        };
    }
    ...
    public void testEncryptDecryptArray(final String input, final String cipherSpecString)
            throws Exception {
        final AEADBlockCipherBean cipherBean =
                newCipherBean(AEADBlockCipherSpec.parse(cipherSpecString));
    ...
    public void testDecryptArrayBackwardCompatibleHeader() {
        final AEADBlockCipherBean cipherBean =
                newCipherBean(new AEADBlockCipherSpec("Twofish", "OCB"));
    ...
    private static KeyStore getTestKeyStore() {
        ...
        bean.setResource(
                new FileResource(new File("src/test/resources/keystores/cipher-bean.jceks")));
        bean.setType("JCEKS");
