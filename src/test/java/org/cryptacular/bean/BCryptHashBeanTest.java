...
public class BCryptHashBeanTest {
    ...
    public Object[][] getHashData() {
        return new Object[][] {
            ...
            {"x", "$2a$12$w6IdiZTAckGirKaH8LU8VOxEvP97cFLEW5ePVJzhZilSa5c.V/uMK"},
            {
                ...
                "$2a$6$.rCVZVOThsIa97pEDOxvGuRRgzG64bvtJ0938xuqzv18d3ZpQhstC"
            },
            {
                "abcdefghijklmnopqrstuvwxyz",
                "$2a$8$aTsUwsyowQuzRrDqFflhgekJ8d9/7Z3GV3UcgvzQW3J5zMyrTvlz."
            },
        };
    }
    ...
    public void testHash(final String password, final String expected) {
        final BCryptHashBean.BCryptParameters params =
                new BCryptHashBean.BCryptParameters(expected);
