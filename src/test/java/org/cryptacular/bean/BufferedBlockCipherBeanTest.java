...
public class BufferedBlockCipherBeanTest {
    ...
    public Object[][] getTestArrays() {
        return new Object[][] {
            new Object[] {
                ...
                "Able was I ere I saw elba.", "AES/CBC/PKCS5", new RBGNonce(16),
            },
    ...
    public Object[][] getTestStreams() {
        return new Object[][] {
            new Object[] {
                "src/test/resources/plaintexts/lorem-5000.txt", "AES/CBC/PKCS7", new RBGNonce(16),
            },
            new Object[] {
            ...
            new Object[] {
                "src/test/resources/plaintexts/lorem-1200.txt", "AES/CFB/PKCS5", new RBGNonce(16),
            },
            new Object[] {
                "src/test/resources/plaintexts/lorem-1200.txt", "AES/ECB/PKCS5", new RBGNonce(16),
            },
        };
    }
