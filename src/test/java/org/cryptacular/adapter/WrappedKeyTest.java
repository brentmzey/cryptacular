...
public class WrappedKeyTest {
    ...
    public void testKeyEquivalence(
            final String algorithm, final String pubKeyPath, final String privKeyPath)
            throws Exception {
        final KeyPair wrappedPair =
                new KeyPair(
    ...
    private static void writeFile(final String path, final byte[] data) throws IOException {
