...
public class ExtensionReaderTest {
    ...
    public Object[][] getBasicConstraints() {
        return new Object[][] {
            new Object[] {
                CertUtil.readCertificate(CRT_PATH + "thawte-premium-server-ca.crt"), true,
            },
            new Object[] {
                CertUtil.readCertificate(CRT_PATH + "login.live.com.crt"), false,
            },
        };
    }
        ...
        return new Object[][] {
            new Object[] {
                ...
                new AccessDescription[] {
                    new AccessDescription(
                            AccessDescription.id_ad_ocsp, uri("http://EVSecure-ocsp.verisign.com")),
                    new AccessDescription(
    ...
    public void testReadKeyUsage(final X509Certificate cert, final int expected) throws Exception {
