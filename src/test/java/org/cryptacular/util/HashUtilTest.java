...
public class HashUtilTest {
    ...
    public Object[][] getSaltedHashData() {
        return new Object[][] {
            ...
            },
            {
                new SHA1Digest(),
                new Object[] {
                    ByteUtil.toBytes("protoporphyrin-9"), SALT,
                },
                1,
            ...
            },
            {
                new SHA256Digest(),
                new Object[] {
                    SALT, ByteUtil.toBytes("N-arachidonoylethanolamine"),
                },
                5,
    ...
    public void testCompareHash(
            final Digest digest, final byte[] hash, final int iterations, final byte[] data)
            throws Exception {
